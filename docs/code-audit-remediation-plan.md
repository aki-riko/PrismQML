...
| P7 Python 规范债务 | 进行中 | 已完成框架签名/生成枚举例外、异常边界前四批、P7E–P7H，以及 P7I-A–P7I-D5。P7I-F 已完成 F1 userCard/QML 组合/Engine 装配、F2 `create_splash()`、F3a/F3b SQL、F4 PageManager、F5a `addPage()`、F5b AUMID 派生、F5c `show()` 与 F5d `WindowCore.__init__()`；统一 runner 已全局隔离 QML 磁盘缓存。F5d 将 `__init__()` `51→19` 行，生产超长函数库存累计 `50→36`、window `20→11`；专项/结构/库存 `103 passed`、窗口联合 `207 passed`，全量 Python `1353 passed / 1 skipped`、QML `169 OK / 0 错误 / 12 跳过`、C++ headless `8/8`、changed QML `0` 与 `git diff --check` 全绿，全部 runner 零可见窗口/零残留。全量门禁中独立发现并修复 TabWidget delegate 替换瞬态 `x=0` 的动画反向重定向，确定性 target 与压力回归均通过。下一批继续 F5 剩余 window 单一调用链；parent 孤儿根窗口、超长 packaged executable 身份退化、`_setAppIcon()`/P7K 路径正确性、SystemTray submenu 与 Mica 均继续独立处理。P7J-P7K 及剩余导入、文件头、benchmark 路径与测试 stdout 政策仍待处理 | `8272d2c0`、`354777fe`、`a8e80e86`、`c962014e`、`bb81d37b`、`e344c8a0`、`e48bb127`、`dafa2a34`、`1512f723`、`8e24b825`、`5fb9e7d8`、`620da260`、`77d045c5`、`cb19eb88`、`fe7a4f4e`、`21211777`、`3b717770`、`f2b4af11`、`cc4567b2`、`ef07928d`、`6db88a88`、`6bf8569f`、`0c482ed0`、`48171374`、`27e831f0`、`d20053c9`、`798f92c`、`42075fa5`、`d2f99369`、`32056b02`、`71854655`、`1b5e072`、`093b7dec`、`a90beb8`、`2be95663`、`977966f`、`2d0881dc`、`5b483469`、`65b2524`、`0b273ad2`、`a248dd77` |
