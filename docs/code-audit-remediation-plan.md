...
| P6 QML 规范债务 | 进行中 | P6A–P6C14 与 P6D 已完成小批记录保持不变；P1+ 已完成，`buttons` 当前批已归零，`inputs` 已开始逐个清理。全库真实基线 2,972（成员顺序 1,805、分节术语 1,128、颜色 17、数值 22，QML013 0），22 项 QML011 全部等待 P8A 的 LoginWindowLightShadow 删除/公开决策 | `d5b5852`、`8e3ba4b0`、`e98adebb`、`557930af`、`b0d23808`、`49d6d6d0`、`09c696df`、`a877c2c7`、`6fc6e645`、`2a22c115`、`06eb4af9`、`685d063e`、`bcf0c737`、`4c22e7bc`、`bad57911`、`b281b7b`、`85a75ff3`、`0e438e60`、`1f9d1038`、`b1050f84`、`d4e2e11e`、`10b25427`、`8c633f4f`、`6810e12c`、`1758f484`、`49a899d5`、`0946eea5`、`2c1be8dd`、`cbf934d2`、`4e383715`、`bff2b32b`、`95c3db84` |
| P7 Python 规范债务 | 待执行 |  |  |
