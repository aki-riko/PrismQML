...
| P6 QML 规范债务 | 进行中 | P6A–P6C18 与 P6D 已完成的小批记录保持不变；扫描器已覆盖字符串、固定数值、数组、callable、examples QML010 与高置信 primitive 传播，P6C16–18 已迁移 MultiSelectToken、数据组件透明色与 ColorPicker 固定色板。当前全库为 2,589 项：QML008 1,521、QML009 1,014、QML010 54、QML011 0、QML013 0；examples 固定 43 行 QML010，DataWidgetCore 销毁期静态 fallback 留待独立设计。最新全量 Python 2233/1、QML 169/0/12、CTest 9/9 + native 2/2、扫描专项 71、changed 0 | `d5b5852`、`8e3ba4b0`、`e98adebb`、`557930af`、`b0d23808`、`49d6d6d0`、`09c696df`、`a877c2c7`、`6fc6e645`、`2a22c115`、`06eb4af9`、`685d063e`、`bcf0c737`、`4c22e7bc`、`bad57911`、`b281b7b`、`85a75ff3`、`0e438e60`、`1f9d1038`、`b1050f84`、`d4e2e11e`、`10b25427`、`8c633f4f`、`6810e12c`、`1758f484`、`49a899d5`、`0946eea5`、`2c1be8dd`、`cbf934d2`、`4e383715`、`bff2b32b`、`95c3db84`、`41565d4b`、`e17b06ca`、`c284433f`、`744eb6ec`、`ca6eb64b`、`af0b0cd4`、`28664920`、`a17f46a8`、`263851c1`、`165dbd4`、`8e29044c`、`86d7e0ee`、`dc5cf90`、`f329a3e`、`668cfda`、`89474354`、`78ff168`、`4e2e4401`、`369724f`、`8d1860f8` |
