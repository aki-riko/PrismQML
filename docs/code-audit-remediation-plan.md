...
| P5 Rust 与维护工具 | 进行中 | P5A：Rust 6/6、Python 140、QML 169/0/12、CTest 7/7、Build All 五平台全绿；P5B：两种控制台模式均真实 probe 181 类型且错误非零退出；P5C 未开始 | `b44c2dc5`、`6d96a2a`、`9bb5271` |
| P6 QML 规范债务 | 待执行 |  |  |
| P7 Python 规范债务 | 待执行 |  |  |
| P8 资源注册 | 待执行 |  |  |
| P9 最终验收 | 待执行 |  |  |
