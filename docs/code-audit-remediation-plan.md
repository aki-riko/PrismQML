...
| P7 Python 规范债务 | 进行中 | 已完成框架签名/生成枚举例外、异常边界前四批、P7E–P7H，以及 P7I-A–P7I-D5。P7I-F 已完成 F1 userCard/QML 组合/Engine 装配、F2 `create_splash()`、F3a/F3b SQL、F4 PageManager、F5a `addPage()`、F5b AUMID 派生、F5c `show()`、F5d `WindowCore.__init__()`、F5e `AcrylicHelper.grabAndBlur()`、F5f `_gaussian_blur_image()` 与 F6a `SqlListModel.refresh()` 失败原子性；统一 runner 已全局隔离 QML 磁盘缓存。F6a 让 `refresh()` 在 count、列解析或首页读取抛出普通/process-control 异常时，于 `modelReset` 发出前恢复 query state、role 表与原 cache，异常对象原样传播，失败路径不发 `queryChanged/countChanged`；生产超长函数库存保持 `34`（models `3`）。真实删除已查询数据库输入、router/formatter 原地污染及三阶段变异均已覆盖；聚焦 `20 passed`、SQL 联合 `124 passed`、全量 Python `1592 passed / 1 skipped`、QML `169 OK / 0 错误 / 12 跳过`、C++ headless `8/8`、changed QML `0`、Python 3.9 AST 与 `git diff --check` 全绿，两路独立 Review P0–P3 全零，全部 runner 零可见窗口/零残留。Python fallback 缺失文件误建继续严格留给 P7K；下一批进入 F6b `_sql_query_tools.normalize_one()`，F5 正确性债务、F7、P7J-P7K 及剩余导入、文件头、benchmark 路径与测试 stdout 政策仍待处理 | `8272d2c0`、`354777fe`、`a8e80e86`、`c962014e`、`bb81d37b`、`e344c8a0`、`e48bb127`、`dafa2a34`、`1512f723`、`8e24b825`、`5fb9e7d8`、`620da260`、`77d045c5`、`cb19eb88`、`fe7a4f4e`、`21211777`、`3b717770`、`f2b4af11`、`cc4567b2`、`ef07928d`、`6db88a88`、`6bf8569f`、`0c482ed0`、`48171374`、`27e831f0`、`d20053c9`、`798f92c`、`42075fa5`、`d2f99369`、`32056b02`、`71854655`、`1b5e072`、`093b7dec`、`a90beb8`、`2be95663`、`977966f`、`2d0881dc`、`5b483469`、`65b2524`、`0b273ad2`、`a248dd77`、`2521d690`、`ac562a72`、`8f20dec`、`900cad2`、`a0dc885e`、`6d60680f` |
