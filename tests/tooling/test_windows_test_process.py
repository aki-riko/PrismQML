...
if sys.platform == "win32":
    import scripts._test_support.windows.cleanup as windows_test_cleanup
    ...
    from scripts._test_support.windows.api import (
        CREATE_SUSPENDED,
    ...
    from scripts._test_support.windows.process import _WindowsTestBoundary
