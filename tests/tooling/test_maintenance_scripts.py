...
from scripts.manual.gallery_i18n import (
    _apply_manual_gallery_translation as apply_manual_gallery_translation,
)
from scripts.manual.gallery_i18n import (
    _build_manual_gallery_locales as build_manual_gallery_locales,
)
...
def test_manual_gallery_scripts_resolve_project_root_after_archival():
    assert apply_manual_gallery_translation.ROOT == PROJECT_ROOT
    assert build_manual_gallery_locales.ROOT == PROJECT_ROOT
