...
def test_prism_design_datetime_picker_popup_selection_highlight(qapp):
    ...
    try:
        ...
        popup = keep[-1][1]
        assert _rgb(popup.property("_selectionHighlightColor")) == (221, 244, 247)

        setTheme(Theme.DARK)
        keep.append(_build_file(engine, popup_path))
        dark_popup = keep[-1][1]
        assert _rgb(dark_popup.property("_selectionHighlightColor")) == (23, 74, 82)
    finally:
...
def test_prism_design_public_input_entries_light_and_dark(qapp):
    ...
    try:
        ...
        assert direct_combo.property("radius") == 10
...
"""))
        ...
        assert combo_family.property("multiRadius") == 10
        assert combo_family.property("treeRadius") == 10
        assert combo_family.property("treeFlatCount") == 2
        assert combo_family.property("multiTreeRadius") == 10
        assert combo_family.property("multiTreeFlatCount") == 2
        assert combo_family.property("fontRadius") == 10
...
"""))
        ...
        assert choice_inputs.property("filterRadius") == 10
        assert _rgb(choice_inputs.property("filterColor")) == (248, 251, 252)
        assert choice_inputs.property("spinRadius") == 10
        assert _rgb(choice_inputs.property("spinColor")) == (252, 254, 255)
        assert _rgb(choice_inputs.property("spinTextColor")) == (18, 34, 38)
        assert choice_inputs.property("spinValue") == 4
        assert choice_inputs.property("checkType") == 0
        assert _rgb(choice_inputs.property("checkColor")) == (11, 127, 137)
        assert choice_inputs.property("radioType") == 1
        assert _rgb(choice_inputs.property("radioColor")) == (11, 127, 137)
        assert choice_inputs.property("switchType") == 2
        assert _rgb(choice_inputs.property("switchColor")) == (11, 127, 137)
...
"""))
        ...
        assert utility_inputs.property("shortcutRadius") == 10
        assert _rgb(utility_inputs.property("shortcutColor")) == (252, 254, 255)
        ...
        assert _rgb(utility_inputs.property("sliderTrackColor")) == (221, 233, 237)
        assert _rgb(utility_inputs.property("sliderHandleColor")) == (252, 254, 255)
        assert _rgb(utility_inputs.property("mediaDividerColor")) == (11, 127, 137)
        assert _rgb(utility_inputs.property("mediaHandleColor")) == (252, 254, 255)
        assert _rgb(utility_inputs.property("mediaHandleIconColor")) == (82, 105, 112)
...
"""))
        ...
        assert dark_inputs.property("comboRadius") == 10
        assert _rgb(dark_inputs.property("filterColor")) == (16, 24, 27)
        assert _rgb(dark_inputs.property("spinColor")) == (26, 37, 41)
        assert _rgb(dark_inputs.property("spinTextColor")) == (238, 247, 248)
        assert _rgb(dark_inputs.property("checkColor")) == (109, 235, 242)
        assert _rgb(dark_inputs.property("sliderTrackColor")) == (12, 21, 24)
        assert _rgb(dark_inputs.property("sliderHandleColor")) == (26, 37, 41)
        assert _rgb(dark_inputs.property("mediaDividerColor")) == (109, 235, 242)
        assert _rgb(dark_inputs.property("mediaHandleColor")) == (26, 37, 41)
        assert _rgb(dark_inputs.property("mediaHandleIconColor")) == (168, 186, 191)
...
"""))
        cropper = keep[-1][1]
        assert cropper.property("previewRadius") == 10
        assert _rgb(cropper.property("previewBackground")) == (248, 251, 252)
        assert _rgb(cropper.property("previewBorder")) == (220, 233, 237)
        assert _rgb(cropper.property("previewIcon")) == (11, 127, 137)
        assert _rgb(cropper.property("previewText")) == (82, 105, 112)
        assert _rgb(cropper.property("dialogBackground")) == (238, 245, 247)
        assert cropper.property("dialogType") == 0
        assert cropper.property("dialogPreviewRadius") == 10
...
"""))
        ...
        assert dark_cropper.property("previewRadius") == 10
        assert _rgb(dark_cropper.property("previewBackground")) == (16, 24, 27)
        assert _rgb(dark_cropper.property("previewBorder")) == (38, 58, 65)
        assert _rgb(dark_cropper.property("previewIcon")) == (109, 235, 242)
        assert _rgb(dark_cropper.property("previewText")) == (168, 186, 191)
        assert _rgb(dark_cropper.property("dialogBackground")) == (9, 14, 16)
        assert dark_cropper.property("dialogType") == 0
        assert dark_cropper.property("dialogPreviewRadius") == 10
    finally:
        for component, item in reversed(keep):
            item.deleteLater()
            component.deleteLater()
