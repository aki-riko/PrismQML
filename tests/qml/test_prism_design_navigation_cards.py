...
def _assert_nav_item(item, background, border, content):
    assert item.property("_navItemRadius") == 10
...
def _assert_nav_panels(item, nav_background, view_background):
    assert item.property("navBarCornerRadius") == 14
    ...
    assert item.property("navViewCornerRadius") == 14
...
"""))
        ...
        _assert_nav_item(nav_bar_item, (238, 249, 251), (7, 95, 104), (11, 127, 137))
...
"""))
        ...
        _assert_nav_item(nav_view_item, (238, 249, 251), (7, 95, 104), (11, 127, 137))
...
"""))
        ...
        assert settings_card.property("borderRadius") == 14
        assert _rgb(settings_card.property("color")) == (252, 254, 255)
...
"""))
        ...
        _assert_nav_item(dark_nav_bar_item, (24, 39, 44), (60, 203, 213), (109, 235, 242))
...
"""))
        ...
        _assert_nav_item(dark_nav_view_item, (24, 39, 44), (60, 203, 213), (109, 235, 242))
...
"""))
        dark_card = keep[-1][1]
        assert dark_card.property("borderRadius") == 14
        assert _rgb(dark_card.property("color")) == (26, 37, 41)
...
"""))
        ...
        assert dark_settings_card.property("borderRadius") == 14
        assert _rgb(dark_settings_card.property("color")) == (26, 37, 41)
    finally:
