...
HOVER_POLICY_COUNTS = {
    ...
    "controls/buttons/Button/_internal/ButtonDropdownSurface.qml": 2,
    ...
    "controls/data/AudioWaveform.qml": 1,
    "controls/data/_internal/AudioWaveformContent.qml": 2,
    "controls/data/Carousel/_internal/CarouselFactories.qml": 1,
    ...
    "controls/inputs/Slider/SliderCore.qml": 0,
    "controls/inputs/Slider/_internal/SliderDefaultContent.qml": 1,
    "controls/inputs/Slider/_internal/SliderRangeContent.qml": 1,
    "controls/inputs/Slider/BeforeAfterSlider.qml": 1,
    "controls/data/FlipView/_internal/PipsPagerContent.qml": 2,
