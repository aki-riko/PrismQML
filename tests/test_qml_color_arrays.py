...
from scripts.qml_color_arrays import color_array_literal_lines
...
GLOBAL_PALETTE_VALUE_LINES = {
    308, 310, 312, 314, 316, 318, 323, 324, 397, 398, 401, 402, 405, 406,
    423, 424, 425, 426, 427, 428, 437, 443, 444,
}
