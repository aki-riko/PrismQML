...
if __package__:
    ...
    from .desktop import _PrivateDesktop
    from .monitor import _RunOptions, _monitor_windows_child
    from .result import capture_boundary_result, log_boundary_result
    from .startup import create_suspended_process
else:
    import api as _api
    from cleanup import (
        CleanupIssue,
