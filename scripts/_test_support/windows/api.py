...
# CreateProcessW does no PATH lookup; these two codes mean it could not locate argv[0].
# CreateProcessW 不做 PATH 查找; 这两个错误码表示它无法定位 argv[0]。
PATH_LOOKUP_ERROR_CODES = frozenset((ERROR_FILE_NOT_FOUND, ERROR_PATH_NOT_FOUND))
