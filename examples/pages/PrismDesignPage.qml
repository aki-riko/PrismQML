...
Item {
    ...
    readonly property string darkAuditEvidenceKeys: darkAudit.darkAuditEvidenceKeys

    // ==================== Internal Methods 内部方法 ====================
    function setSkin(value) { Enums.setSkin(value) }
    function setTheme(value) { Enums.setTheme(value) }
