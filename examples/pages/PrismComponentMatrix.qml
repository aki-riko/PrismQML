...
ExampleCard {
    ...
    Column {
        ...
        Row {
            ...
            InfoBar { title: "Info"; content: "Overlay token"; severity: "info"; width: 280; duration: Enums.duration.persistent }
            InfoBar { title: "Success"; content: "Semantic token"; severity: "success"; width: 280; duration: Enums.duration.persistent }
        }
