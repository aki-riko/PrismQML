@echo off
setlocal
REM Android arm64 APK build Android arm64 APK 构建
...
if not defined PRISM_ANDROID_BUILD_DIR set "PRISM_ANDROID_BUILD_DIR=%PRISM_ARTIFACT_ROOT%\cpp\android-arm64-apk"
...
if errorlevel 1 (popd & echo ARM64_CONFIG_FAIL & exit /b 11)

call "%NINJA%" -C "%PRISM_ANDROID_BUILD_DIR%" prism_demo_make_apk
if errorlevel 1 (popd & echo ARM64_APK_BUILD_FAIL & exit /b 12)

popd
echo ARM64_APK_BUILD_OK
exit /b 0
