...
_LAZY_EXPORTS = {
    ...
    # Icons
    "Icon": (".icons", "Icon"),
    "IconCore": (".icon_base", "IconCore"),
    "resolveIconColor": (".icon_base", "resolveIconColor"),
    "make_icon": (".icon_base", "make_icon"),
    "make_theme_icon": (".icon_base", "make_theme_icon"),
    "paint_icon": (".icon_base", "paint_icon"),
