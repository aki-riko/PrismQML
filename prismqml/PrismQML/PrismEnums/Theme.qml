...
QtObject {
    ...
    readonly property color tableHoverColor: isNeo ? _neo.muted : (isNeumorphism ? _neu.muted : (isTicket ? _ticket.muted : (root.isDark ? constants.themeColors.tableHoverDark : constants.themeColors.tableHoverLight)))
