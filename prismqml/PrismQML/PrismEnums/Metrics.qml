...
QtObject {
 ...
 readonly property int navigationScroll: 500 // Navigation wheel smooth scroll animation 导航滚轮平滑滚动动画
 ...
 readonly property int navigationScrollStep: 24 // Navigation wheel scroll distance per tick 导航滚轮每格滚动距离
