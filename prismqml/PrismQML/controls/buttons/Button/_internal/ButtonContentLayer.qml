...
Item {
    ...
    Item {
        ...
        anchors.left: contentLayer.buttonControl.contentAlignment === _skin.button.align_left
                      ? parent.left : undefined
        anchors.right: contentLayer.buttonControl.contentAlignment === _skin.button.align_right
                       ? parent.right : undefined
        anchors.horizontalCenter:
            contentLayer.buttonControl.contentAlignment === _skin.button.align_center
            ? parent.horizontalCenter : undefined
        anchors.leftMargin:
            contentLayer.buttonControl.contentAlignment === _skin.button.align_left
            ? contentLayer.buttonControl._contentLeadingPadding : 0
        anchors.rightMargin:
            contentLayer.buttonControl.contentAlignment === _skin.button.align_right
            ? contentLayer.buttonControl._contentTrailingPadding : 0
        anchors.horizontalCenterOffset:
            contentLayer.buttonControl.contentAlignment === _skin.button.align_center
            ? (contentLayer.buttonControl.feature === _skin.button.feature_split
               ? -_skin.controlSize.splitButtonContentOffset
    ...
    Loader {
        ...
        x: {
            if (contentLayer.buttonControl.contentAlignment === _skin.button.align_left)
                return contentLayer.buttonControl._contentLeadingPadding
            if (contentLayer.buttonControl.contentAlignment === _skin.button.align_right)
                return parent.width - width - contentLayer.buttonControl._contentTrailingPadding
            var centerOffset = contentLayer.buttonControl.feature === _skin.button.feature_split
                               ? -_skin.controlSize.splitButtonContentOffset
                               : (contentLayer.buttonControl._showsDropdownIndicator
                                  ? -_skin.spacing.m : 0)
