...
QtObject {
    ...
    // ==================== Required Props 必需属性 ====================
    required property Item target  // Target component to detect 要检测的目标组件

    // ==================== Public Props 公开属性 ====================
    property bool isInViewport: true  // Visible by default 默认可见
    property bool ready: false  // Initialization-done flag 初始化完成标志
    ...
    function _init() {
        ...
        _updateViewport()
        ready = true  // Mark initialization complete 标记初始化完成
    }
