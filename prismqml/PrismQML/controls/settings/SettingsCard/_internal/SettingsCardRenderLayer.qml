// SettingsCardRenderLayer - Settings card rendering orchestration 设置卡片渲染编排层
...
// Keeps type-specific surfaces outside the public entry component 将类型分支渲染移出公开入口组件
Item {
    id: renderLayer

    // ==================== Required Props 必需属性 ====================
    required property var cardControl

    // ==================== Internal Props 内部属性 ====================
    readonly property var control: cardControl
