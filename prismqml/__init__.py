...
_LAZY_EXPORTS = {
    ...
    "setTheme": (".python.runtime.appearance", "setTheme"),
    "getTheme": (".python.runtime.appearance", "getTheme"),
    "setSkin": (".python.runtime.appearance", "setSkin"),
    "getSkin": (".python.runtime.appearance", "getSkin"),
    "isDark": (".python.runtime.appearance", "isDark"),
    "setAccentColor": (".python.runtime.appearance", "setAccentColor"),
    "getAccentColor": (".python.runtime.appearance", "getAccentColor"),
    "accentQColor": (".python.runtime.appearance", "accentQColor"),
    "getThemeManager": (".python.runtime.appearance", "getThemeManager"),
    # Icons
    ...
    "get_icon_provider": (".python.runtime", "get_icon_provider"),
    "prepare_windows_icon": (
    ...
    "installDwmSyncFilter": (".python.runtime", "installDwmSyncFilter"),
    ...
    "register_types": (".python.runtime", "register_types"),
    ...
    "get_qrcode_generator": (".python.runtime", "get_qrcode_generator"),
    "get_qrcode_provider": (".python.runtime", "get_qrcode_provider"),
    # Mica & Acrylic
    ...
    "get_screen_eyedropper_manager": (".python.runtime", "get_screen_eyedropper_manager"),
    # Clipboard
    ...
    "get_svg_provider": (".python.runtime", "get_svg_provider"),
    # SystemTray
